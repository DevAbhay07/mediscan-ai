                  ...
                  {prediction.severity && (
                    <div className="mb-4">
                      ...
                      >
                        ...
                        {prediction.severity === 'high' && 'High Priority - Requires immediate attention'}
                        {prediction.severity === 'medium' && 'Medium Priority - Schedule follow-up'}
                        {prediction.severity === 'low' && 'Low Priority - Routine monitoring'}
                      </Badge>
                    </div>
                  )}
                  ...
                  {prediction.recommendations && Array.isArray(prediction.recommendations) && prediction.recommendations.length > 0 && (
                    <div className="mb-4">
                      ...
                      <ul className="space-y-1">
                        {(prediction.recommendations as string[]).map((rec: string, index: number) => (
